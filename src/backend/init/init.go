...
import (
	...
	backendRemote "github.com/hugorut/terraform/src/backend/remote"
	backendArtifactory "github.com/hugorut/terraform/src/backend/remote-state/artifactory"
	backendAzure "github.com/hugorut/terraform/src/backend/remote-state/azure"
	backendConsul "github.com/hugorut/terraform/src/backend/remote-state/consul"
	backendCos "github.com/hugorut/terraform/src/backend/remote-state/cos"
	backendEtcdv2 "github.com/hugorut/terraform/src/backend/remote-state/etcdv2"
	backendEtcdv3 "github.com/hugorut/terraform/src/backend/remote-state/etcdv3"
	backendGCS "github.com/hugorut/terraform/src/backend/remote-state/gcs"
	backendHTTP "github.com/hugorut/terraform/src/backend/remote-state/http"
	backendInmem "github.com/hugorut/terraform/src/backend/remote-state/inmem"
	backendKubernetes "github.com/hugorut/terraform/src/backend/remote-state/kubernetes"
	backendManta "github.com/hugorut/terraform/src/backend/remote-state/manta"
	backendOSS "github.com/hugorut/terraform/src/backend/remote-state/oss"
	backendPg "github.com/hugorut/terraform/src/backend/remote-state/pg"
	backendS3 "github.com/hugorut/terraform/src/backend/remote-state/s3"
	backendSwift "github.com/hugorut/terraform/src/backend/remote-state/swift"
	backendCloud "github.com/hugorut/terraform/src/cloud"
)
