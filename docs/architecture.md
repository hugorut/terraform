...
[the `command` package](https://pkg.go.dev/github.com/hugorut/terraform/internal/command).
...
[`backend.Operation`](https://pkg.go.dev/github.com/hugorut/terraform/internal/backend#Operation)
...
[`backend.Backend`](https://pkg.go.dev/github.com/hugorut/terraform/internal/backend#Backend), using a
mapping table in
[the `backend/init` package](https://pkg.go.dev/github.com/hugorut/terraform/internal/backend/init).

Backends that are able to execute operations additionally implement
[`backend.Enhanced`](https://pkg.go.dev/github.com/hugorut/terraform/internal/backend#Enhanced);
...
[`local.Local`](https://pkg.go.dev/github.com/hugorut/terraform/internal/backend/local#Local),
...
(either
[`statemgr.Filesystem`](https://pkg.go.dev/github.com/hugorut/terraform/internal/states/statemgr#Filesystem) if the
...
[`terraform.Context`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#Context),
...
[`Plan`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#Context.Plan)
or
...
[package `configs`](https://pkg.go.dev/github.com/hugorut/terraform/internal/configs).
A whole configuration (the root module plus all of its descendent modules)
is represented by
[`configs.Config`](https://pkg.go.dev/github.com/hugorut/terraform/internal/configs#Config).
...
[`configload`](https://pkg.go.dev/github.com/hugorut/terraform/internal/configs/configload]),
via
[`configload.Loader`](https://pkg.go.dev/github.com/hugorut/terraform/internal/configs/configload#Loader).
...
[the `statemgr` package](https://pkg.go.dev/github.com/hugorut/terraform/internal/states/statemgr),
with most practical managers implementing the full set of operations
described by
[`statemgr.Full`](https://pkg.go.dev/github.com/hugorut/terraform/internal/states/statemgr#Full)
...
The implementation
[`statemgr.Filesystem`](https://pkg.go.dev/github.com/hugorut/terraform/internal/states/statemgr#Filesystem) is used
...
[`states.State`](https://pkg.go.dev/github.com/hugorut/terraform/internal/states#State)
...
[`GraphNodeConfigResource`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#GraphNodeConfigResource)
...
[`terraform.GraphTransformer`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#GraphTransformer).
...
* [`ConfigTransformer`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#ConfigTransformer),
  which creates a graph vertex for each `resource` block in the configuration.

* [`StateTransformer`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#StateTransformer),
  which creates a graph vertex for each resource instance currently tracked
  in the state.

* [`ReferenceTransformer`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#ReferenceTransformer),
...
* [`ProviderTransformer`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#ProviderTransformer),
...
[`terraform.Graph`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#Graph), which
...
[the low-level `dag` package](https://pkg.go.dev/github.com/hugorut/terraform/internal/dag#AcyclicGraph.Walk)
(where "DAG" is short for [_Directed Acyclic Graph_](https://en.wikipedia.org/wiki/Directed_acyclic_graph)), in
[`AcyclicGraph.Walk`](https://pkg.go.dev/github.com/hugorut/terraform/internal/dag#AcyclicGraph.Walk).
However, the "interesting" Terraform walk functionality is implemented in
[`terraform.ContextGraphWalker`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#ContextGraphWalker),
...
* `EnterPath` is called once for each module in the configuration, taking a
  ...
  [`terraform.EvalContext`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#EvalContext)
...
[`states.SyncState`](https://pkg.go.dev/github.com/hugorut/terraform/internal/states#SyncState)
...
[`terraform.Execute`](https://pkg.go.dev/github.com/hugorut/terraform/internal/erraform#Execute).
...
[`terraform.BuiltinEvalContext`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#BuiltinEvalContext).
...
[`terraform.GraphNodeExecutable`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#GraphNodeExecutable),
...
* [NodePlannableResource.Execute](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#NodePlannableResourceInstance.Execute), which handles the `plan` operation.

* [`NodeApplyableResourceInstance.Execute`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#NodeApplyableResourceInstance.Execute), which handles the main `apply` operation.

* [`NodeDestroyResourceInstance.Execute`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#EvalWriteState), which handles the main `destroy` operation.
...
1. Analyze the configuration expressions to see which other objects they refer
  ...
  [`lang.References`](https://pkg.go.dev/github.com/hugorut/terraform/internal/lang#References),
  or more often one of the helper wrappers around it:
  [`lang.ReferencesInBlock`](https://pkg.go.dev/github.com/hugorut/terraform/internal/lang#ReferencesInBlock)
  or
  [`lang.ReferencesInExpr`](https://pkg.go.dev/github.com/hugorut/terraform/internal/lang#ReferencesInExpr)
...
of the methods on [`lang.Scope`](https://pkg.go.dev/github.com/hugorut/terraform/internal/lang#Scope);
most commonly,
[`lang.EvalBlock`](https://pkg.go.dev/github.com/hugorut/terraform/internal/lang#Scope.EvalBlock)
or
[`lang.EvalExpr`](https://pkg.go.dev/github.com/hugorut/terraform/internal/lang#Scope.EvalExpr).
...
[`terraform.GraphNodeDynamicExpandable`](https://pkg.go.dev/github.com/hugorut/terraform/internal/terraform#GraphNodeDynamicExpandable).
