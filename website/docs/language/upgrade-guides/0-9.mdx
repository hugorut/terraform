...
[Terraform Changelog](https://github.com/hugorut/terraform/blob/main/CHANGELOG.md).
...
[is available here](https://github.com/hugorut/terraform/blob/v0.9.11/website/source/docs/backends/legacy-0-8.html.md).
This includes
