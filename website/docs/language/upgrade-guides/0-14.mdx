...
[the Terraform Changelog](https://github.com/hugorut/terraform/blob/v0.14/CHANGELOG.md).
...
[open a feature request issue](https://github.com/hugorut/terraform/issues/new?labels=enhancement%2C+new&template=feature_request.md)
