...
func (e *MoveEndpoint) String() string {
	// Our src pseudo-AbsMoveable representing the relative
...
func UnifyMoveEndpoints(moduleAddr Module, relFrom, relTo *MoveEndpoint) (modFrom, modTo *MoveEndpointInModule) {
	...
	// ultimately trying to unify to. For our src purposes
...
func (e *MoveEndpoint) prepareMoveEndpointInModule(moduleAddr Module, wantType TargetableAddrType) *MoveEndpointInModule {
	...
	// src intermediate representation produced by ParseMoveEndpoint.
	...
	case ModuleInstance:
		...
		case ModuleInstanceAddrType:
			// Since our src representation is already a module instance,
...
// similar members that would be for src use only anyway.
