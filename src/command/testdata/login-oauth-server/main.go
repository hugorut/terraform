...
//
//     import oauthserver "github.com/hashicorp/terraform/src/command/testdata/login-oauth-server"
...
import (
	...
	oauthserver "github.com/hashicorp/terraform/src/command/testdata/login-oauth-server"
)
