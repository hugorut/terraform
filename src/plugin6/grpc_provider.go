...
import (
	...
	"github.com/hashicorp/terraform/src/plugin6/convert"
	"github.com/hashicorp/terraform/src/providers"
	proto6 "github.com/hashicorp/terraform/src/tfplugin6"
...
func (p *GRPCProvider) GetProviderSchema() (resp providers.GetProviderSchemaResponse) {
	...
	// Some providers may generate quite large schemas, and the src default
