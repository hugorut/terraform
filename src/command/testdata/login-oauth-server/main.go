...
//
//     import oauthserver "github.com/hugorut/terraform/src/command/testdata/login-oauth-server"
...
import (
	...
	oauthserver "github.com/hugorut/terraform/src/command/testdata/login-oauth-server"
)
