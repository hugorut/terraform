...
import (
	...
	backendRemote "github.com/hashicorp/terraform/src/backend/remote"
	backendArtifactory "github.com/hashicorp/terraform/src/backend/remote-state/artifactory"
	backendAzure "github.com/hashicorp/terraform/src/backend/remote-state/azure"
	backendConsul "github.com/hashicorp/terraform/src/backend/remote-state/consul"
	backendCos "github.com/hashicorp/terraform/src/backend/remote-state/cos"
	backendEtcdv2 "github.com/hashicorp/terraform/src/backend/remote-state/etcdv2"
	backendEtcdv3 "github.com/hashicorp/terraform/src/backend/remote-state/etcdv3"
	backendGCS "github.com/hashicorp/terraform/src/backend/remote-state/gcs"
	backendHTTP "github.com/hashicorp/terraform/src/backend/remote-state/http"
	backendInmem "github.com/hashicorp/terraform/src/backend/remote-state/inmem"
	backendKubernetes "github.com/hashicorp/terraform/src/backend/remote-state/kubernetes"
	backendManta "github.com/hashicorp/terraform/src/backend/remote-state/manta"
	backendOSS "github.com/hashicorp/terraform/src/backend/remote-state/oss"
	backendPg "github.com/hashicorp/terraform/src/backend/remote-state/pg"
	backendS3 "github.com/hashicorp/terraform/src/backend/remote-state/s3"
	backendSwift "github.com/hashicorp/terraform/src/backend/remote-state/swift"
	backendCloud "github.com/hashicorp/terraform/src/cloud"
)
